...
--Pet Simulator X
local Luxt = Luxtl.CreateWindow("CrysstalBlueHUB", 6284583030)
...
ff:Label("Welcome to CrysstalBlueHUB")
...
--Pet Champions
local Luxt = Luxtl.CreateWindow("CrysstalBlueHUB", 8623447599)
local petsTab = Luxt:Tab("Essentails")
local cf = creditsTab:Section("Auto Claims")
local mainTab = Luxt:Tab("Auto-Farm", 8623447599)
local petsTab = Luxt:Tab("Pets")